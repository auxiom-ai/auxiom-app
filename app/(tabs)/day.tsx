...
export default function DayScreen() {
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      ...
      const selectedDayInt = selectedDayIndex // 0 = Monday, 6 = Sunday

      const { data, error } = await supabase
        .from("users")
        .update({
          delivery_day: selectedDayInt,
        })
        .eq("id", userId)
        .select()
      ...
      if (error) {
        ...
        // Navigate to the next onboarding screen or complete onboarding
        // router.push("/next-page") // Update this to your next page
    ...
    <ThemedView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.mainContent}>
          <ThemedText style={styles.title}>What day would you like your weekly podcast delivered?</ThemedText>
